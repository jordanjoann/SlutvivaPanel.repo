...
export function gtaServerConfig(inst: Instance): string {
  const description = inst.description?.trim() || "Slutvival FiveM QBCore server";
  return [
    ...
    'sets tags "slutvival,default,qbcore,qb-core"',
    'sets locale "en-US"',
    ...
    "ensure [defaultmaps]",
    "",
    "ensure hunz3d_brutualist_coffee",
    "ensure hunz_3d_service_station",
    "ensure 17mov_VehicleDirtSystem",
    "ensure 17mov_WindowCleaning",
    "ensure codem-phone-props",
    "ensure codem-notify",
    "ensure codem-supreme-notification",
    "ensure codem-dispatch",
    "ensure codem-mdtProp",
    "ensure codem-mdt",
    "ensure codem-phone",
    "ensure codem-adminmenu",
    "ensure codem-report",
    "ensure codem-trade",
    "ensure jg-vehiclemileage",
    "ensure jg-mechanic-props",
    "ensure jg-mechanic",
    "ensure jg-hud",
    "ensure rd-coordsmanager",
    "ensure rd-npcs",
    "ensure rd-taxi",
    "ensure vms_spawnselector",
    "ensure slutvival-body-dainty",
    "ensure slutvival-body-ks",
    "ensure slutvival-body-toned",
    "ensure slutvival-clothing",
    "ensure screenshot-basic",
    "ensure slutvival-clothing-audit",
    "ensure slutvival-ui",
    "ensure slutvival-map",
    "ensure slutvival-alive",
